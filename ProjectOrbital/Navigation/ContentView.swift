...
struct ContentView: View {
    ...
    init() {
        button = RiveViewModel(fileName: "menu_button", stateMachineName: "State Machine")
        // RiveViewModel(fileName: "menu_button", stateMachineName: "State Machine", animationName: "open", autoplay: false)
    }
